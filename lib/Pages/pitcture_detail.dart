    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(children: <Widget>[
          Image.network(i, fit: BoxFit.cover, height: 600, width: 1000.0),
          Positioned(
            bottom: 0.0,
            left: 0.0,
            right: 0.0,
...
//  PicturePreviewPage({this.title});
//
//  final String title;
//
//  @override
//  PicturePreviewPageState createState() => new PicturePreviewPageState();
//}
...
////    Dio dio = new Dio();
////    Response response = await dio.get('http://192.168.50.146:8080/week/1');
...
////
////    setState(() {
////      _picturesList = ret['data'];
////    });
////
////    print('week:  ' + '  id ' + _picturesList.toString());
////  }
//
//  @override
//  Widget build(BuildContext context) {
